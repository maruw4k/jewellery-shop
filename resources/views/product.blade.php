...
@section('content')
    ...
    <div class="container">
        <p><a href="{{ url('/shop') }}">Sklep</a> / {{ $product->name }}</p>
        <h1>{{ $product->name }}</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <form action="{{ url('/cart') }}" method="POST" class="side-by-side">
                    ...
                    <input type="submit" class="btn btn-success btn-lg" value="Dodaj do koszyka">
                </form>
                ...
                <form action="{{ url('/wishlist') }}" method="POST" class="side-by-side">
                    ...
                    <input type="hidden" name="name" value="{{ $product->name }}">
                    <input type="hidden" name="price" value="{{ $product->price }}">
                    <input type="submit" class="btn btn-primary btn-lg" value="Dodaj do listy życzeń">
                </form>
